      ...
      <div className="container">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Have questions about The Matrix? Want to learn more before committing? Reach out and we'll get back to you.
          </p>
        </div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea name="message" value={formData.message} onChange={handleChange} placeholder="Tell us what's on your mind..." className="input-field" rows="5" required />
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-xl" style={{ background: 'var(--bg-primary)' }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <a href="#" className="flex items-center gap-3 p-4 rounded-lg transition-all duration-300 hover:transform hover:-translate-y-1" style={{ background: 'var(--bg-secondary)', textDecoration: 'none', color: 'var(--text-primary)' }}>
                  <Twitter size={20} style={{ color: 'var(--accent-primary)' }} />
                  <span className="text-sm font-medium">Twitter</span>
                </a>
                <a href="#" className="flex items-center gap-3 p-4 rounded-lg transition-all duration-300 hover:transform hover:-translate-y-1" style={{ background: 'var(--bg-secondary)', textDecoration: 'none', color: 'var(--text-primary)' }}>
                  <Instagram size={20} style={{ color: 'var(--accent-primary)' }} />
                  <span className="text-sm font-medium">Instagram</span>
                </a>
                <a href="#" className="flex items-center gap-3 p-4 rounded-lg transition-all duration-300 hover:transform hover:-translate-y-1" style={{ background: 'var(--bg-secondary)', textDecoration: 'none', color: 'var(--text-primary)' }}>
                  <Youtube size={20} style={{ color: 'var(--accent-primary)' }} />
            ...
            <div className="p-6 rounded-xl border" style={{ background: 'var(--bg-tertiary)', borderColor: 'var(--border-subtle)' }}>
